...
namespace Entities
{
    public class Employee
    {
        ...
        public Employee(string tc, string name, string surname, DateTime bdate, string adress, string tel, string mail, string departmentName, string authorityName, Guid departmentId,
        Guid authorityId)
        {
